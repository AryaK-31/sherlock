        ...
        <section className=' h-min  bg-black  '>
            <div className='lg:grid lg:grid-cols-2'>
                <div className='text-center mx-auto lg:text-left p-10 lg:flex lg:flex-col lg:py-40'>
                    ...
                    <Link href="https://anantya2023.pccoe.hosting.acm.org/about13" target={'_blank'} scroll={false}><div className="relative group w-100 max-w-xl mt-12 mx-auto">
                            ...
                            <div className="items-left">
                                <p className="text-white px-3 py-2 flex justify-center text-xl lg:divide-x md:divide-x divide-gray-600">
                                    ...
                                    <span className='text-3xl md:pl-8 lg:pl-8 flex justify-center text-pink-600 cursor-pointer'>
                                        <Link href="https://anantya2023.pccoe.hosting.acm.org/about13" target={'_blank'} scroll={false}><BsFillArrowRightCircleFill /> </Link>
                    ...
                    <Link href="https://docs.google.com/document/d/1WpqhCrIhSHs_nHF4OjU9m6TkoTZ7HbQmKZyODrbwiqM/edit?usp=sharing" target={'_blank'} scroll={false}><div className="relative group w-100 max-w-xl mt-12 mx-auto">
                        <div className="absolute -inset-1 bg-gradient-to-r from-[#05c1fa] to-[#fa056b] rounded-lg blur opacity-95 group-hover:from-[#6f02e4] group-hover:to-[#fa0505] group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
                        <div className="relative py-1 bg-black ring-1 ring-gray-900/5 rounded-lg leading-none ">
                            <div className="items-left">
                                <p className="text-white px-3 py-2 flex justify-center text-xl lg:divide-x md:divide-x divide-gray-600">
                                   
                                    <span className='lg:text-blue-400 text-yellow-400 pl-4 pr-4 font-medium'>Rule Book</span>
                                    <span className='text-3xl md:pl-8 lg:pl-8 flex justify-center text-pink-600 cursor-pointer'>
                                        <Link href="https://docs.google.com/document/d/1WpqhCrIhSHs_nHF4OjU9m6TkoTZ7HbQmKZyODrbwiqM/edit?usp=sharing" target={'_blank'} scroll={false}><AiFillBook/> </Link>
